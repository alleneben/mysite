...
const AnnouncementPage = () => {
    return (
        <Layout>
            ...
            <p>
                If you want to be an expert in programming, an expert in developing hybrid 
                mobile apps, web applications, database development, then am your right guy
                in Kumasi to take you through this journey.
            </p>
            <p>
                You can browse through my profile site and see what I can offer you as a programmer
                and a developer.
            </p>
